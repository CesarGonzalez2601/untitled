package sv.com.pruebanodospacientes.controller;
...
import sv.com.pruebanodospacientes.modelo.ArbolDeClasificacion;
import sv.com.pruebanodospacientes.modelo.Nodo;
import sv.com.pruebanodospacientes.modelo.Paciente;
import sv.com.pruebanodospacientes.modelo.PacientesDAO;
...
public class PacienteController {
    ...
    private void inicializarPacientesDesdeBD() {
        ...
        for (Paciente paciente : pacienteDAO.obtenerTodosLosPacientes()) {
    ...
    private void dibujarListaPacientes(GraphicsContext gc, String categoria, double x, double y, String tipo, double parentX, double parentY) {
        ...
        List<Paciente> pacientesPorCategoria = obtenerPacientesPorCategoria(tipo);
        ...
        if (!pacientesPorCategoria.isEmpty()) {
            ...
            for (Paciente paciente : pacientesPorCategoria) {
                gc.setFill(Color.BLACK);
    ...
    private double calcularAnchoMaximoTexto(GraphicsContext gc, List<Paciente> pacientes) {
        double maxWidth = 0;
    ...
    private List<Paciente> obtenerPacientesPorCategoria(String tipo) {
        List<Paciente> pacientesFiltrados = new ArrayList<>();
        for (Paciente paciente : arbol.getPacientes()) {
            if ((tipo.equals("M") && paciente.getGenero().equals("M")) ||
                    (tipo.equals("F") && paciente.getGenero().equals("F")) ||
